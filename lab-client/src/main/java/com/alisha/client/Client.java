package com.alisha.client;

import com.alisha.client.utilities.Console;
import com.alisha.client.utilities.InputManager;
import com.alisha.client.utilities.OutputManager;
...
public class Client {
    ...
    private static void initCommandList() {
        ...
        Client.LIST_OF_COMMANDS.add("add_if_max");
        ...
        Client.LIST_OF_COMMANDS.add("remove_any_by_distance");
